...
It turned out that `kaslr` is actually disabled even though it was specified in the qemu boot flag, i guess it's because of the kernel image version (5.8.3).
