...
After all challenges were completed, we were left with the last web challenge called **paper-2**, at that time we were the 30th place on the leaderboard (Africa).

So winning depends on solving that last challenge.

Before I started, they were already working on it but not much progress gotten.

Fun fact, it was labelled "that crazy hard web" as a thread, I actually started 2 days after the CTF began because i was occupied with school work.

![hehe](hehe.png)

It had this strict CSP rule

![csp](csp.png)

After about 10 hours later I got this idea
...
But unfortunately, I didn't get it solved that day and I gave up on it to check for other things

The next day I skipped school lecture though (although they eventually cancelled it - lucky me) 
...
<figure>
  <img src="ready.png" alt="instruction set">
  <figcaption style="text-align:center;">
...
Tbh i can't even remember what this thing i'm saying is all about but basically it works although not optimized 😭

And i figured using CSS injection wouldn't work and we had to search other format
...
Finally, we got the first blood in Africa placing us at the 1st place.
