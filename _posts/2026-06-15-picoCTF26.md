...
<figure>
  ...
  <figcaption style="text-align:center;">
    The current TryHackMe leaderboard for KOTH (even after 4 years I'm still at the top - the number of solves shows I was really addicted to it haha)
  </figcaption>
</figure>
...
I still remember stumbling into a simple format string attack for a GOT overwrite with basically no prior pwn knowledge. It took me about two days to figure out, but I eventually got it working and that and some other pwn challenges I solved was enough to push me into 1st place.
...
After that, I got recruited by some friends to focus on winning **picoCTF**. We played as team *8h037*, and we placed 1st.
...
<figure>
  ...
  <figcaption style="text-align:center;">
    My profile (somehow 1337 always ends up in my name lol)
  </figcaption>
</figure>
